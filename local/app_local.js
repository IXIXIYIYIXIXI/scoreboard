...
let getDataFromDatabase = function() {
    ...
    let users = [
        ...
        [11, "Ying", "#ff8b00", "https://ubisoft-avatars.akamaized.net/90ec9900-f752-4d0a-bb5c-74dcfbdb279c/default_256_256.png"],
        ...
        [14, "Andrew O.", "#30d5c8", "https://ih1.redbubble.net/image.1710759265.1978/st,small,507x507-pad,600x600,f8f8f8.jpg"],
        [15, "Akshat", "#000080", "https://media-exp1.licdn.com/dms/image/C4E03AQEHfl_HMMoDTQ/profile-displayphoto-shrink_200_200/0/1623441742391?e=1634169600&v=beta&t=tKkntivlxD4X5XpZW3c7Ydc-o3qJ-7GB6uO61KEQ5Ww"],
        [16, "James", "#86bd82", "https://www.pngkey.com/png/full/204-2049354_ic-account-box-48px-profile-picture-icon-square.png"],
        [17, "Michael", "#0cdf8e", "https://www.pngkey.com/png/full/204-2049354_ic-account-box-48px-profile-picture-icon-square.png"]
    ];
